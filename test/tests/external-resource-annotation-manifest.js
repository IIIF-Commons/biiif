...
const customAnnotationsManifestUrl = 'http://test.com/external-resource-annotation-manifest';
...
describe('commenting text with format', async () => {
    ...
    it('has correct annotation body id', async () => {
        assert(annotationBody.id === 'https://www.morphosource.org/media/morphosource/dcm_sample/platypus/platypus_manifest_20_slices.json');
    });
